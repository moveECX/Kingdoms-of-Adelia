...
**Als Nächstes (Roadmap durchgespielt — jetzt Politur):** Balancing-Pass (Trainingszeiten/Monster-Stats/Gründungs-/Palast-Kosten von Dev-Werten `[A]` kalibrieren); Content (Eindeutschung der Anzeigenamen; fehlende Gebäude/Einheiten — Citadel/Sanctuary/Türme/Fallen — baubar machen); Phase-4/5-Vereinfachungen schließen (Support-Angriff, Schiff/Cap, Schrein-Zeit-Aktivierung, „castled"/3×3-Palast-Slot); Kysely-0.29-Upgrade; Prod-Build auf `dist/*.js`. Login: `dev` / `password123` (Seed).
